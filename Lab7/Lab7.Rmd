...
legend("topright",inset=c(0,0.2),c("Simulated","Theoretical"),col=c("Blue","Red"),lwd=4,lty=1:2,bty="n",title=title) # Legend #
...
mychisim(n1=100,sigma1=4,mean1=10,iter=1000,ymax=0.10)
# n_1=200,iter=1000,μ_1=10,σ_1=4
mychisim(n1=200,sigma1=4,mean1=10,iter=1000,ymax=0.10)
```

### The final mychisq
```{r}
#n_1=10,iter=1500,μ_1=20,σ_1=10 
mychisim(n1=10,sigma1=10,mean1=20,iter=1500,ymax=0.15)
```
...
```{r}
#n_1=10,iter=1500,μ_1=20,σ_1=10
myTsim(n1=10,iter=1500,mean1=20,sigma1=10,ymax=0.5)
```
...
#	n_1=5,n_2=20,μ_1=5,μ_2=10,σ_1=σ_2=4,iter=10000
myFsim2(n1=5,n2=20,mean1=5,mean2=10,sigma1=4,sigma2=4,iter=10000)
#	n_1=30,n_2=25,μ_1=3,μ_2=5,σ_1=σ_2=10,iter=10000
myFsim2(n1=30,n2=25,mean1=3,mean2=5,sigma1=10,sigma2=10,iter=10000,ymax=1.2)
```
